...
<head>
    ...
    <title>Deployment Manager | stayora.com.pk</title>
...
<body class="bg-gray-50 min-h-screen text-gray-900">
        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-gray-200 pb-6">
            <div>
                ...
                <div class="flex items-center mt-2 text-sm text-gray-500">
                    ...
                    <a href="https://github.com/stayoraguesthouse-code/StayOra" target="_blank" class="hover:text-indigo-600 transition-colors">grapheart247/stayora</a>
                </div>
            </div>
    ...
    <script>
        ...
        executeDeployBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                deployStatusResult.innerHTML = `<span class="text-green-400">> ✅ Success! Deployed Commit ID: ${commitSelect.value.substring(0,7)} at ${new Date().toLocaleTimeString()}<br>> Website is now LIVE on stayora.com.pk</span>`;
