    ...
    <div class="max-w-4xl mx-auto py-10 px-4">
        ...
        <div class="mb-8 flex flex-col md:flex-row md:items-start justify-between gap-4 border-b border-gray-200 pb-6">
            ...
            <div class="flex flex-col items-end gap-2">
                <button id="refreshBtn" class="inline-flex items-center px-5 py-2.5 bg-indigo-600 text-white rounded-lg text-sm font-semibold hover:bg-indigo-700 focus:ring-4 focus:ring-indigo-100 transition-all shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="commitSelect" class="block w-full pl-3 pr-10 py-3 text-base border-gray-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 rounded-lg border bg-white transition-all">
                        <option value="" disabled selected>Refresh to fetch commits</option>
                    </select>
                </div>
            </div>
        </div>
        ...
        <div id="newChangesAlert" class="hidden animate-fade-in mb-6 bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-center justify-between">
            <div class="flex items-center text-amber-800">
                ...
                <span class="text-sm font-medium">New commits detected on <strong id="alertBranchName">main-so</strong>!</span>
            </div>
        ...
        <div id="detailsBox" class="hidden glass-card rounded-xl shadow-lg overflow-hidden border-indigo-100 border-2 animate-fade-in">
            <div class="bg-indigo-50 px-6 py-4 border-b border-indigo-100 flex justify-between items-center">
                <h2 class="text-sm font-bold text-indigo-800 uppercase tracking-wider">Commit Information</h2>
                <span id="detailStatus" class="bg-green-100 text-green-700 text-[10px] px-2 py-1 rounded-full font-bold uppercase">Ready</span>
            </div>
            <div class="p-6">
                    ...
                    <div>
                        ...
                        <div class="space-y-4">
                            <div class="flex flex-col">
                                <span class="text-[10px] font-bold text-gray-400 uppercase">Commit Hash</span>
                                <code id="detailId" class="text-indigo-600 font-mono text-sm mt-1">---</code>
                            </div>
                            <div class="flex flex-col">
                                <span class="text-[10px] font-bold text-gray-400 uppercase">Timestamp</span>
                                <span id="detailDate" class="text-gray-700 text-sm font-medium mt-1">---</span>
                            </div>
                        </div>
                    </div>
                    <div class="bg-gray-50 rounded-lg p-4">
                        <h4 class="text-[10px] font-bold text-gray-400 uppercase mb-2">Message & Description</h4>
                        <p id="detailDesc" class="text-gray-700 leading-relaxed text-sm whitespace-pre-line">
                ...
                <div class="mt-8 pt-6 border-t border-gray-100 flex justify-end">
                    <button class="w-full md:w-auto bg-gray-900 text-white px-10 py-3 rounded-lg font-bold hover:bg-black transition-all shadow-xl hover:-translate-y-0.5 active:translate-y-0">
                        Deploy Selection
                    </button>
                </div>
            </div>
